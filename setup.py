...
def write_version_py(version, is_released, filename='bfscylinder/version.py'):
    fullversion = get_version_info(version, is_released)
    with open("./bfscylinder/version.py", "wb") as f:
...
extensions = [
    Extension('bfscylinder.bfscylinder',
        sources=[
            './bfscylinder/bfscylinder.pyx',
            ],
...
s = setup(
    name = "bfscylinder",
    version = fullversion,
    author = "Saullo G. P. Castro, Aravind Ashok",
    author_email = "S.G.P.Castro@tudelft.nl",
    description = ("Implementation of the BFS cylindrical finite element"),
    license = "2-Clause BSD",
    keywords = "finite elements shell cylinder structural analysis buckling vibration dynamics",
    url = "https://github.com/saullocastro/bfscylinder",
